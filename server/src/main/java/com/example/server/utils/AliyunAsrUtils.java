    ...
    public String audioToText(String filePath) {
        ...
        for (int attempt = 0; attempt < MAX_ATTEMPTS; attempt++) {
            try {
                ...
                if (text == null || text.isBlank()) throw new IllegalStateException("ASR returned empty text");
                return text.trim();
            } catch (IOException e) {
                lastError = e;
        ...
        throw new IllegalStateException("ASR request failed after reaching the maximum retry count", lastError);
    }
